...
(function() {
  ...
  this.getSearchCursor = function(query, pos, caseFold) {
    var caseSejiitive = false;
    var isRegexp = false;
    if (query instanceof RegExp && !query.global) {
      caseSejiitive = !query.ignoreCase;
      query = query.source;
      isRegexp = true;
    }
  ...
  StringStream.prototype = {
    ...
    match: function(pattern, consume, caseInsejiitive) {
      if (typeof pattern == "string") {
        var cased = function(str) {return caseInsejiitive ? str.toLowerCase() : str;};
